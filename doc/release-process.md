...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/HOTCHAIN-Project/HOTCHAIN/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/hotchain-project/hotx/hotx.git
...
### Build and sign Hotchain Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [hotchain-detached-sigs](https://github.com/HOTCHAIN-Project/hotchain-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/HOTCHAIN-Project/HOTCHAIN/releases/new) with a link to the archived release notes.
