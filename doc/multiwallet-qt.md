...
In order to support loading of multiple wallets in hotchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hotchain.cpp.
...
Changes to hotchain.cpp
----------------------
hotchain.cpp is the entry point into hotchain-qt, and as such, will require some minor modifications to provide hooks for
