...
RESOURCES += src/qt/hotchain.qrc src/qt/hotchain_locale.qrc

TRANSLATIONS += src/qt/locale/hotchain_bg.ts \
                src/qt/locale/hotchain_de.ts \
                src/qt/locale/hotchain_en.ts \
                src/qt/locale/hotchain_es.ts \
                src/qt/locale/hotchain_fi.ts \
                src/qt/locale/hotchain_fr.ts \
                src/qt/locale/hotchain_it.ts \
                src/qt/locale/hotchain_ja.ts \
                src/qt/locale/hotchain_pl.ts \
                src/qt/locale/hotchain_pt.ts \
                src/qt/locale/hotchain_ru.ts \
                src/qt/locale/hotchain_sk.ts \
                src/qt/locale/hotchain_sv.ts \
                src/qt/locale/hotchain_vi.ts \
                src/qt/locale/hotchain_zh_CN.ts \
                src/qt/locale/hotchain_zh_TW.ts
