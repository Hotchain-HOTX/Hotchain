Contributing to Hotchain Core
============================

The Hotchain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hotchain Core project, and is not to be
confused with overall Hotchain Network Protocol consensus changes.

Whether a pull request is merged into Hotchain Core rests with the project merge
...
The project leader is the release manager for each Hotchain Core release.
