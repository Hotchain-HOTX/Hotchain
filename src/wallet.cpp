...
/**
 * Fees smaller than this (in upie) are considered zero fee (for transaction creation)
...
bool CWallet::MintableCoins()
{
    ...
    CAmount nZpieBalance = GetZerocoinBalance(false);
