...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04d8f3c122f0cebe04b0d8c22369641a5e8b31b99ec35574c504bb68c1aaadfb7afd4f9e843fda8770275427d1a5721d5e40a6ba8fef4e499d0e81db6df47e7fe3");
        nDefaultPort = 9069;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // PIVX starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nMaxReorganizationDepth = 100;
        nEnforceBlockUpgradeMajority = 1; // 75%
        nRejectBlockOutdatedMajority = 1; // 95%
        nToCheckBlockUpgradeMajority = 1; // Approximate expected amount of blocks in 7 days (1440*7.5)
        nMinerThreads = 0;
        ...
        nBlockEnforceSerialRange = 3000; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = 3000; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = 2000; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = 2000; //Last valid accumulator checkpoint
        nBlockEnforceInvalidUTXO = 2000; //Start enforcing the invalid UTXO's
        ...
        nEnforceNewSporkKey = 2000; //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 2000; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0447a052e673ddce4448632ddec60aae4172099a4f8d9130f899cb2a2a2b7a70d22944ade0826cfc397c8b560219971230e049ec567825d84defc308cb25dd4658") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1543687682;
