...
#   c) node1 mines 32 blocks, so now node 0 has 60001hotx, node 1 has 4250hotx, node2 has none.
#   d) node0 sends 601 hotx to node2, in two transactions (301 hotx, then 300 hotx).
